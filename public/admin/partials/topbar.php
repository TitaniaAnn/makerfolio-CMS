...
<header class="admin-topbar">
    ...
    <div class="admin-topbar__right">
        <a href="/" target="_blank" rel="noopener" class="admin-topbar__view-site" title="Open the public site in a new tab" aria-label="View public site">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:.25rem;">
        ...
        <?php endif; ?>
        <a href="/admin/account/2fa" style="font-size:.8rem; color:var(--fog,#7a8090); text-decoration:none; margin-right:.5rem;" title="Manage your two-factor authentication">2FA</a>
