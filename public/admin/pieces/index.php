...
<main class="admin-main">
    ...
    <div class="admin-content">
        ...
        <?php else: ?>
        <?php if ($canReorder): ?>
            <p class="muted" style="margin-bottom:.75rem;">Drag the <span class="reorder-handle" style="display:inline; cursor:default;">⋮⋮</span> handle to reorder pieces. Order saves automatically.</p>
        <?php endif; ?>
