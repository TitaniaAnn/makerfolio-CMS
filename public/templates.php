...
<section class="section">
    <div class="container">
        ...
        <div class="templates-filters">
            <a href="/templates" class="<?= $category === '' ? 'active' : '' ?>"><?= e(PageText::get('templates', 'filter_all')) ?></a>
            <?php foreach ($categories as $cat): ?>
            <a href="/templates?category=<?= urlencode($cat['category']) ?>"
            ...
            <div class="template-card">
                ...
                <div class="template-card__files">
                    ...
                    <div class="template-file-row">
                        ...
                        <a href="/templates/download?file_id=<?= $f['id'] ?>" class="template-file-row__dl">
